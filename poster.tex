...
\headerbox{References}{name=references,column=0,span=3,below=methods,above=bottom}{
...
\headerbox{Acknowledgments}{name=acknowledgments,column=3,span=2,below=methods,above=bottom}{
